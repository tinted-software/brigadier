...
public class StringArgumentType implements ArgumentType<String> {
  private static final StringArgumentType WORD_ARGUMENT =
      new StringArgumentType(StringType.SINGLE_WORD);
  private static final StringArgumentType QUOTED_ARGUMENT =
      new StringArgumentType(StringType.QUOTABLE_PHRASE);
  private static final StringArgumentType GREEDY_ARGUMENT =
      new StringArgumentType(StringType.GREEDY_PHRASE);
