...
public class CommandContext<S> {
  ...
  /**
   * Special modifier for running this context and children. Only relevant if it's not last in
   * chain. <br>
   * Effects:
   *
   * <ul>
   *   <li>Exceptions from {@link #command} or {@link #modifier} will be ignored
   *   <li>Result of command will be number of elements run by element in chain (instead of sum of
   *       {@link #command} results
   * </ul>
   */
